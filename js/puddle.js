...
var puddle = new Puddle(10,35,335,420,"white");
...
function DrawPuddle() {
    ...
    if (canvas.getContext) {
        ...
        ctx.beginPath;
        ctx.fillStyle = puddle.pColor;
        ctx.strokeStyle = 'black';
        ctx.lineWidth = 2;
    
        // Draw a rounded rectangle
        drawRoundedRect(ctx, puddle.pX, puddle.pY, puddle.pWidth, puddle.pHeight, 20); // x, y, width, height, radius
        ctx.fill();
        ctx.stroke();
    }
}
